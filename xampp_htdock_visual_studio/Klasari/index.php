...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-dark p-2">
	  <div class="container-fluid">
	    <a class="navbar-brand d-flex align-items-center" href="index.php?page=beranda">
	    	<img src="assets/img/pabar.png" width="30" height="24">
	    	&nbsp; <span>KLASARI</span>
	    </a>
			...
			<div class="container header-box mt-3">
				<div class="row">
					<div class="col-md-12 text-center">
						...
						<h3 class="mt-2">Sumber Informasi Kampung Kalsari</h3>
	...
	<footer id="footer" class="mt-5 p-3 bg-dark">
		<div class="container text-center">
			<p class="text-white">&copy;&nbsp; Copyright By moh aksah</p>
		</div>
	</footer>
