...
<body class="hold-transition sidebar-mini">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php?page=home" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Klasari</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="index.php?page=user" class="d-block"><?= $_SESSION['pengguna'] ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="index.php?page=lihat-akun" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Lihat Data Akun</p>
                </a>
              </li>
