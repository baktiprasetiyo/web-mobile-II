				...
				<div class="row">
					<div class="col-lg-12">
						<form method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label for="file">Masukkan File <span class="text-danger mt-1" style="font-size: 10px;">(Ekstensi File yang di perbolehkan : jpg, png max. 2MB)</span></label>
			...
			<div class="card-body">
				...
				<?php 
				 ...
				 ?>
					<tr>
						<th><?= $no++; ?></th>
						<th class="text-center"><?= $data['judul'] ?></th>
		...
		if(!empty($gambar)) {
			if(in_array($ekstensi, $ekstensi_boleh) === true) {
				if($ukuran < 2000000) {
					...
					$sql = mysqli_query($con, "INSERT INTO tbl_gallery VALUES ('', '$gambar', '$judul')");
